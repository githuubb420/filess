            ...
            [
                [
                    InlineKeyboardButton(
                        "😊 Information", callback_data="about"),
...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text=f"<b>○ Creator : <a href='tg://user?id={OWNER_ID}'>White Prime</a>\n○ Channel F1 : @ITHard\n○ Channel №2 : @ITHardNews",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
async def channel_post(client: Client, message: Message):
    ...
    try:
        ...
        await reply_text.edit_text("Is there something wrong..!")
        return
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton(
        "🔁 Link", url=f'https://telegram.me/share/url?url={link}')]])
    await reply_text.edit(f"<b>Link to loading</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview=True)
...
async def batch(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton(
        "🔁 Link", url=f'https://telegram.me/share/url?url={link}')]])
    await second_message.reply_text(f"<b> Drouting link</b>\n\n{link}", quote=True, reply_markup=reply_markup)
